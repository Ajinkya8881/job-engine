...
def discover_greenhouse_companies():
    # Huge List of Indian + Global Tech 
    known_companies = [
...
def discover_yc_companies():
    yc_companies = [
        ...
        "meesho", "clevertap", "fampay", "orangehealth", "vahan"
    ]
    current = set()
    try:
...
def run_discovery():
    print("Expanding India Tech Discovery (Flipkart, PhonePe, Razorpay, etc.)...")
    discover_greenhouse_companies()
    discover_lever_companies()
    discover_yc_companies()
    print("Company discovery complete.")
